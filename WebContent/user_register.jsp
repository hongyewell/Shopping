...
<body>
			...
			<div class="navlef_sub">
				...
				<div class="navlef_snr">
					...
					<ul class="navlef_snrul">
						...
						<li class="navlef_snrli">|<a href="#">茶黑刺粉虱</a></li>
			...
			<div class="navlef_sub">
				...
				<div class="navlef_snr">
					...
					<ul class="navlef_snrul">
						...
						<li class="navlef_snrli">|<a href="#">抗倒伏</a></li>
						<li class="navlef_snrli">|<a href="#">矮化</a></li>
						<li class="navlef_snrli">|<a href="#">生根</a></li>
						<p class="clear"></p>
					</ul>
					<p class="clear"></p>
				</div>
				<div class="navlef_snr">
					...
					<p class="clear"></p>
					<ul class="navlef_snrul">
						<li class="navlef_snrli">|<a href="#">多效唑</a></li>
			...
			<div class="regis_det">
				<div class="regis_dnr">
					...
					<form action="#" method="post">
						...
						<table cellspacing="0" cellpadding="0" class="regis_dform">
							...
							<tr>
								...
								<td><p class="regis_dfsp">地区须选到县或区</p></td>
							</tr>
							<tr>
					...
					<div class="regis_dftk">
						...
						<br> 1. 接受条款。<br>
						以任何方式进入安徽惠富强农资交易平台网站即表示您同意自己已经与安徽惠富强农资交易平台订立本协议，且您将受本协议的条款和条件(“条款”)
						约束。安徽惠富强农资交易平台可随时自行全权决定更改“条款”。如“条款”有任何变更，安徽惠富强农资交易平台将在其网站上刊载公告，通知予您。如您不同意相关变更，必须停止使用“服务”。经修订的“条款”一经在安徽惠富强农资交易平台网站的公布后，立即自动生效。您应在第一次登录后仔细阅读修订后的“条款”，并有权选择停止继续使用“服务”；一旦您继续使用“服务”，则表示您已接受经修订的“条款”，当您与安徽惠富强农资交易平台发生争议时，应以最新的服务协议为准。除另行明确声明外，任何使“服务”范围扩大或功能增强的新内容均受本协议约束。除非经安徽惠富强农资交易平台的授权高层管理人员签订书面协议，本协议不得另行作出修订。<br>
						<br> 2.谁可使用安徽惠富强农资交易平台网站？<br>
						...
						<br>
						<br> 3. 收费。<br>本公司保留在根据第1条通知您后，收取“服务”费用的权利。您因进行交易、向本公司获取有偿服务或接触本公司服务器而发生的所有应纳税赋，以及相关硬件、软件、通讯、网络服务及其他方面的费用均由您自行承担。本公司保留在无须发出书面通知，仅在安徽惠富强农资交易平台网站公示的情况下，暂时或永久地更改或停止部分或全部“服务”的权利。<br>
						<br> 4.安徽惠富强农资交易平台网站仅作为交易地点。 <br>
						...
						<br>
						<br> 5.您的资料和供买卖的物品。 <br>
						“您的资料”包括您在注册、交易或列举物品过程中、在任何公开信息场合或通过任何电子邮件形式，向本公司或其他用户提供的任何资料，包括数据、文本、软件、音乐、声响、照片、图画、影像、词句或其他材料。您应对“您的资料”负全部责任，而本公司仅作为您在网上发布和刊登“您的资料”的被动渠道。但是，倘若本公司认为“您的资料”可能使本公司承担任何法律或道义上的责任，或可能使本公司
						(全部或部分地)
						失去本公司的互联网服务供应商或其他供应商的服务，或您未在安徽惠富强农资交易平台规定的期限内登录或再次登录网站，则本公司可自行全权决定对“您的资料”采取本公司认为必要或适当的任何行动，包括但不限于删除该类资料。您特此保证，您对提交给安徽惠富强农资交易平台的“您的资料”拥有全部权利，包括全部版权。您确认，安徽惠富强农资交易平台没有责任去认定或决定您提交给本公司的资料哪些是应当受到保护的，对享有“服务”的其他用户使用“您的资料”，本公司也不必负责。
						<br>
						<br> 5.1 注册义务。 <br> 如您在安徽惠富强农资交易平台网站注册，您同意：<br> (a)
						根根据安徽惠富强农资交易平台网站刊载的会员资料表格的要求，提供关于您或贵公司的真实、准确、完整和反映当前情况的资料；<br>
						(b)
						维持并及时更新会员资料，使其保持真实、准确、完整和反映当前情况。倘若您提供任何不真实、不准确、不完整或不能反映当前情况的资料，或安徽惠富强农资交易平台有合理理由怀疑该等资料不真实、不准确、不完整或不能反映当前情况，安徽惠富强农资交易平台有权暂停或终止您的注册身份及资料，并拒绝您在目前或将来对“服务”(或其任何部份)
						以任何形式使用。如您代表一家公司或其他法律主体在本公司登记，则您声明和保证，您有权使该公司或其他法律主体受本协议“条款”约束。 <br>
						<br> 5.2 会员注册名、密码和保密。 <br>
						...
						(b)
						确保您在每个上网时段结束时，以正确步骤离开网站。安徽惠富强农资交易平台不能也不会对因您未能遵守本款规定而发生的任何损失或损毁负责。
						<br>
						<br> 5.3 关于您的资料的规则。<br>
						您同意，“您的资料”和您供在安徽惠富强农资交易平台网站上交易的任何“物品”（泛指一切可供依法交易的、有形的或无形的、以各种形态存在的某种具体的物品，或某种权利或利益，或某种票据或证券，或某种服务或行为。本协议中“物品”一词均含此义）
						<br>
						<br> a. 不会有欺诈成份，与售卖伪造或盗窃无涉； <br> b.
						不会侵犯任何第三者对该物品享有的物权，或版权、专利、商标、商业秘密或其他知识产权，或隐私权、名誉权； <br> c.
						不会违反任何法律、法规、条例或规章
						(包括但不限于关于规范出口管理、贸易配额、保护消费者、不正当竞争或虚假广告的法律、法规、条例或规章)；<br> d.
						不会含有诽谤（包括商业诽谤）、非法恐吓或非法骚扰的内容；<br> e. 不会含有淫秽、或包含任何儿童色情内容； <br>
						f.
						不会含有蓄意毁坏、恶意干扰、秘密地截取或侵占任何系统、数据或个人资料的任何病毒、伪装破坏程序、电脑蠕虫、定时程序炸弹或其他电脑程序；
						<br> g. 不会直接或间接与下述各项货物或服务连接，或包含对下述各项货物或服务的描述：<br>
							&nbsp;(i) 本协议项下禁止的货物或服务；或 
						<br> &nbsp;(ii) 您无权连接或包含的货物或服务。 
						<br> 此外，您同意不会：<br> (h)
						在与任何连锁信件、大量胡乱邮寄的电子邮件、滥发电子邮件或任何复制或多余的信息有关的方面使用“服务”；<br> (i)
						未经其他人士同意，利用“服务”收集其他人士的电子邮件地址及其他资料；或 <br> (j)
						利用“服务”制作虚假的电子邮件地址，或以其他形式试图在发送人的身份或信息的来源方面误导其他人士。 <br>
						<br> 5.4 被禁止物品。 <br> 您不得在本公司网站公布或通过本公司网站买卖：<br> (a)
						可能使本公司违反任何相关法律、法规、条例或规章的任何物品；或 <br> (b)
						安徽惠富强农资交易平台认为应禁止或不适合通过本网站买卖的任何物品。<br>
						<br> 6. 您授予本公司的许可使用权。 <br> 您授予本公司独家的、全球通用的、永久的、免费的许可使用权利
						(并有权在多个层面对该权利进行再授权)，使本公司有权(全部或部份地)
						...
						<br> 8.交易程序。 <br> 8.1 添加产品描述条目。<br>
						产品描述是由您提供的在安徽惠富强农资交易平台网站上展示的文字描述、图画和/或照片，可以是<br> (a)
						对您拥有而您希望出售的产品的描述；或 <br> (b)
						对您正寻找的产品的描述。您可在安徽惠富强农资交易平台网站发布任一类产品描述，或两种类型同时发布，条件是，您必须将该等产品描述归入正确的类目内。<br>
						安徽惠富强农资交易平台不对产品描述的准确性或内容负责。 <br>
						<br> 8.2 就交易进行协商。 <br>
						...
						<br>
						<br> 8.3 处理交易争议。 <br>
						本公司不会且不能牵涉进交易各方的交易当中。倘若您与一名或一名以上用户，或与您通过本公司网站获取其服务的第三者服务供应商发生争议，您免除安徽惠富强农资交易平台
						(及本公司代理人和雇员) 在因该等争议而引起的，或在任何方面与该等争议有关的不同种类和性质的任何 (实际和后果性的)
						权利主张、要求和损害赔偿等方面的责任。 <br>
						<br> 8.4 运用常识。 <br>
						...
						(反馈数据轰炸)；或在用户未能履行交易范围以外的某些行动时，留下负面的反馈 (反馈恶意强加)。 <br>
						<br> 9.4 不作商业性利用。 <br>
						您同意，您不得对任何资料作商业性利用，包括但不限于在未经安徽惠富强农资交易平台授权高层管理人员事先书面批准的情况下，复制在安徽惠富强农资交易平台网站上展示的任何资料并用于商业用途。<br>
						<br> 10. 终止或访问限制。 <br>
						您同意，在安徽惠富强农资交易平台未向您收费的情况下，安徽惠富强农资交易平台可自行全权决定以任何理由
						(包括但不限于安徽惠富强农资交易平台认为您已违反本协议的字面意义和精神，或您以不符合本协议的字面意义和精神的方式行事，或您在超过90天的时间内未以您的帐号及密码登录网站)
						终止您的“服务”密码、帐户 (或其任何部份) 或您对“服务”的使用，并删除和丢弃您在使用“服务”中提交的
						“您的资料”。您同意，在安徽惠富强农资交易平台向您收费的情况下，安徽惠富强农资交易平台应基于合理的怀疑且经电子邮件通知的情况下实施上述终止服务的行为。安徽惠富强农资交易平台同时可自行全权决定，在发出通知或不发出通知的情况下，随时停止提供“服务”或其任何部份。您同意，根据本协议的任何规定终止您使用“服务”之措施可在不发出事先通知的情况下实施，并承认和同意，安徽惠富强农资交易平台可立即使您的帐户无效，或撤销您的帐户以及在您的帐户内的所有相关资料和档案，和/或禁止您进一步接入该等档案或“服务”。帐号终止后，安徽惠富强农资交易平台没有义务为您保留原帐号中或与之相关的任何信息，或转发任何未曾阅读或发送的信息给您或第三方。此外，您同意，安徽惠富强农资交易平台不会就终止您接入“服务”而对您或任何第三者承担任何责任。第12、13、14和22各条应在本协议终止后继续有效。
						<br>
						<br> 11. 违反规则会有什么后果？ <br>
						在不限制其他补救措施的前提下，发生下述任一情况，本公司可立即发出警告，暂时中止、永久中止或终止您的会员资格，删除您的任何现有产品信息，以及您在网站上展示的任何其他资料：<br>
						(i) 您违反本协议；<br> (ii) 本公司无法核实或鉴定您向本公司提供的任何资料；或 <br> (iii)
						本公司相信您的行为可能会使您、本公司用户或通过本公司或本公司网站提供服务的第三者服务供应商发生任何法律责任。在不限制任何其他补救措施的前提下，倘若发现您从事涉及本公司网站的诈骗活动，安徽惠富强农资交易平台可暂停或终止您的帐户。<br>
						<br> 12. 服务“按现状”提供。 <br>
						...
						(i)“服务”会符合您的要求；<br> (ii)“服务”不会中断，且适时、安全和不带任何错误；<br>
						(iii) 通过使用“服务”而可能获取的结果将是准确或可信赖的； <br> (iv)
						您通过“服务”而购买或获取的任何产品、服务、资料或其他材料的质量将符合您的预期。通过使用“服务”而下载或以其他形式获取任何材料是由您自行全权决定进行的，且与此有关的风险由您自行承担，对于因您下载任何该等材料而发生的您的电脑系统的任何损毁或任何数据损失，您将自行承担责任。您从安徽惠富强农资交易平台或通过或从“服务”获取的任何口头或书面意见或资料，均不产生未在本协议内明确载明的任何保证。
						<br>
						<br> 13. 责任范围。 <br>
						您明确理解和同意，安徽惠富强农资交易平台不对因下述任一情况而发生的任何损害赔偿承担责任，包括但不限于利润、商誉、使用、数据等方面的损失或其他无形损失的损害赔偿
						(无论安徽惠富强农资交易平台是否已被告知该等损害赔偿的可能性)：<br> (i) 使用或未能使用“服务”；<br>
						(ii)
						因通过或从“服务”购买或获取任何货物、样品、数据、资料或服务，或通过或从“服务”接收任何信息或缔结任何交易所产生的获取替代货物和服务的费用；<br>
						(iii) 未经批准接入或更改您的传输资料或数据；<br> (iv)
						任何第三者对“服务”的声明或关于“服务”的行为；或因任何原因而引起的与“服务”有关的任何其他事宜，包括疏忽。 <br>
						<br> 14. 赔偿。 <br>
						...
						<br> 16. 无代理关系。 <br>
						您与安徽惠富强农资交易平台仅为独立订约人关系。本协议无意结成或创设任何代理、合伙、合营、雇用与被雇用或特许权授予与被授予关系。 <br>
						<br> 17. 广告和金融服务。 <br>
						...
						<br>
						<br> 19. 通知。 <br>
						除非另有明确规定，任何通知应以电子邮件形式发送，(就安徽惠富强农资交易平台而言) 电子邮件地址为以本站域名后缀之地址，或
						(就您而言) 发送到您在登记过程中向安徽惠富强农资交易平台提供的电子邮件地址，或有关方指明的该等其他地址。在电子邮件发出二十四
						(24)
						小时后，通知应被视为已送达，除非发送人被告知相关电子邮件地址已作废。或者，本公司可通过邮资预付挂号邮件并要求回执的方式，将通知发到您在登记过程中向安徽惠富强农资交易平台提供的地址。在该情况下，在付邮当日三
						(3) 天后通知被视为已送达。<br>
						<br> 20. 不可抗力。 <br>
						...
						本协议取代您和安徽惠富强农资交易平台先前就相同事项订立的任何书面或口头协议。本协议各方面应受中华人民共和国大陆地区法律的管辖。倘若本协议任何规定被裁定为无效或不可强制执行，该项规定应被撤销，而其余规定应予执行。条款标题仅为方便参阅而设，并不以任何方式界定、限制、解释或描述该条款的范围或限度。本公司未就您或其他人士的某项违约行为采取行动，并不表明本公司撤回就任何继后或类似的违约事件采取行动的权利。<br>
							<br> 22. 诉讼。
						<br> 因本协议或本公司服务所引起或与其有关的任何争议应向人民法院提起诉讼，并以中华人民共和国法律为管辖法律。
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function validator(id) {
			vid = id;
			makeRequest('moduleid=2&action=member&job=' + id + '&value='
					+ Dd(id).value, AJPath, '_validator');
		}
		function _validator() {
		...
		function err_msg(str, id) {
			Dd('d'+id).innerHTML = '<img src="img/check_'+(str ? 'error' : 'right')+'.gif" align="absmiddle"/> '+str;
	...
	<script type="text/javascript">
		...
		var destoon_member = '';
		destoon_member += '<span class="sp">亲！欢迎来到安徽惠富强农资交易平台！</span><a rel="nofollow" href="#">帮助中心</a>';
