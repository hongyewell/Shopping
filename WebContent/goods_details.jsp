                ...
                <div class="sel_detrtr">
					...
					<div class="sel_detrtrsj">
						<p class="sel_detrtrsjp">
							产品价格： <b class="colored">￥660元</b>
						</p>
						<p class="sel_detrtrsjp">
							防治对象： <span class="colored">蚜虫</span>
						</p>
						<p class="sel_detrtrsjp">
							推荐起发数量： <span class="colored" title="起发数量超过2件必定发货">2件</span>
						</p>
						<form id="cartsub" action="/sell/cart.php" method="post">
							<div class="sel_detrtrsjp">
								<span class="sel_detrtrsb">购买数量：</span>
									<a href="javascript:minusAndPlus(0,660);" class="sel_detrtrsa">－</a>
										<input name="total" id="buynum" onblur="modifyGoodsNum(this.value,660);" class="sel_detrtrsaon" value="2" />
									<a href="javascript:minusAndPlus(1,660);" class="sel_detrtrsa">＋</a>
								<span class="sel_detrtrsb">件</span>
								<p class="clear"></p>
							</div>
							<p class="sel_detrtrsjp">总&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价： 
								<b id="tamount" class="colored">1320</b> 元
							</p>
							<p>
						...
						<a href="javascript:void(0);" onclick="checkCart(0);"class="sel_detrtra">
							<img src="img/sell_icongm.gif" onclick="checkCart(0);" title="购买" />
						</a> 
						<a href="/com/shanxiguofeng/sell/" class="sel_detrtra">
							<img src="img/sell_iconjr.jpg" title="加入购物车" />
						</a>
						<a href="javascript:void(0);" onclick="scGoods(0,85730,'http://www.nongyao001.com/sell/show-85730.html','http://www.nongyao001.com/file/upload/201411/18/11-52-19-73-23293.jpg.thumb.jpg');"class="sel_detrtra">
		...
		$(function() {
			...
			$.post(contextPath+'/goodsDetail',data, 'json').done(function(datas) {
				...
				$('#div_img').html(html);
					...
					html2 += "<div>"
						     + '<h4 class="sel_detrtrbt">'+goods.goods_number+'</h4>'
					         + '<ul>'
					         + '<li class="sel_detrtrli">'+goods.goods_type+'</li>'
					         + '<li class="sel_detrtrli">农药登记证：'+goods.goods_registration+'</li>'
					         + '<li class="sel_detrtrli" title='+goods.goods_name+'</li>'
					         + '<li class="sel_detrtrli">产品规格：'+goods.goods_standard+'</li>'
					         + '<li class="sel_detrtrli">证件到期时间：'+goods_deadline+'</li>'
					         + '<li class="sel_detrtrli">诚信度：<img src="img/x2.gif" /></li>'
					         + '<li class="sel_detrtrli">发布时间：'+goods_publish+'</li>'
					         + '<p class="clear"></p>'
					         + '</ul>'
					         + '<p class="sel_detrtrp">生产厂家：'+goods_producer+'</p>'
					         + "</div>"
			    $('#div_info').html(html2); 
