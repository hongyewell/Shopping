                ...
                <form action="">
                    <table class="thr_scform" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td>${id}</td>
                            <td>
                                <img src="img/14-49-35-72-1.jpg.thumb.jpg" width="62" height="62" title="高效氯氟氰菊酯2.5%(乳油)" /></td>
                            <td>高效氯氟氰菊酯2.5%(乳油)</td>
                            <td><span class="thr_scfpri">￥140</span></td>
                            <td>
                                <input type="button" onclick="fixTradeNum(0, 118114, this)" value="-" class="thr_scfbtn"/>
                                <input id="nums118114" onblur="inputFixNum(118114,this.value)" type="text" value="5" class="thr_scfinp"/>
                                <input onclick="    fixTradeNum(1, 118114, this)" type="button" value="+"  class="thr_scfbtn2"/></td>
                            <td><span class="thr_scfpri">￥<b id="amount118114" class="amountct">700.00</b></span></td>
                            <td><a href="javascript:void(0)" rel="nofollow" onclick="notPayNow(118114);" class="thr_scfa">暂不结算</a> | <a href="javascript:void(0)" rel="nofollow" onclick="delCartItem(118114);" class="thr_scfa">删除</a></td>
                        </tr>
                        <tr>
                    ...
                    <div class="thr_scjs">
                        ...
                        <a rel="nofollow" href="/sell/cart.php?step=1" class="thr_scjsa">
                            <img src="img/js_btn.gif"></a></div>
                </form>
            </div>
            <!--thr_sctxt end-->
