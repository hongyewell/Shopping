...
<body>
    <div id="header">
        ...
        <div class="headmid">
            <div class="logo"><a href="#">
                <img src="img/logo.jpg" title="安徽惠富强农资交易平台"></a></div>
            <div class="search">
                <div class="seart">
            ...
            <div class="wei">
                <div class="weixin">
                    <p><a rel="nofollow" href="#">
                        <img src="img/code1.jpg" title="扫一扫关注安徽惠富强农资交易平台官方微信" width="72px" height="72px"></a></p>
                    <p class="weixsp">微信</p>
                </div>
                <div class="weibo">
                    <p><a rel="nofollow" href="#" target="_blank">
                        <img src="img/code2.jpg" title="农药第一网APP" width="72px" height="72px"></a></p>
        ...
        <div class="sel_detr">
            <div class="sel_detrtop">
                <div class="sel_detrtl">
                    <div>
                        <p>
                            <img src="img/17-58-28-76-19486.jpg"  alt="苦参碱0.3%(水剂)新高度 1000ml*12瓶/件 陕西国丰化工有限公司" width="350" height="372"></p>
                ...
                <div class="sel_detrtr">
                    <h4 class="sel_detrtrbt">产品编号85730</h4>
                    <ul>
                        <li class="sel_detrtrli">产品类型：杀虫剂</li>
                        <li class="sel_detrtrli">农药登记证：PD20110116</li>
                        <li class="sel_detrtrli" title="苦参碱0.3%(水剂)">有效成分：苦参碱0.3%(水剂)</li>
                        <li class="sel_detrtrli">产品规格：1000ml*12瓶/件</li>
                        <li class="sel_detrtrli">证件到期时间：2016-01-26</li>
                        <li class="sel_detrtrli">诚信度：<img src="img/x2.gif" /></li>
                        <li class="sel_detrtrli">发布时间：2014-11-18</li>
                        <p class="clear"></p>
                    </ul>
                    <p class="sel_detrtrp">生产厂家：陕西国丰化工有限公司</p>
                    <div class="sel_detrtrg">
                        <b class="sel_detrtrgb">其他规格:</b>
                        <ul class="sel_detrtrgul">
                            <li class="sel_detrtrgli"><a href="#" class="on">1000ml*12瓶/件</a></li>
                            <li class="sel_detrtrgli"><a rel="nofollow" href="show-85728.html">200ml*20瓶/件</a></li>
                            <li class="sel_detrtrgli"><a rel="nofollow" href="show-85729.html">300ml*20瓶/件</a></li>
                            <li class="sel_detrtrgli"><a rel="nofollow" href="show-93993.html">500ml*20瓶/件</a></li>
                            <p class="clear"></p>
                        </ul>
                        <p class="clear"></p>
                    </div>
                    <div class="sel_detrtrsj">
                        <p class="sel_detrtrsjp">产品价格： <b class="colored">￥660元</b></p>
                        <p class="sel_detrtrsjp">防治对象： <span class="colored">蚜虫</span></p>
                        <p class="sel_detrtrsjp">推荐起发数量： <span class="colored" title="起发数量超过2件必定发货">2件</span></p>
                        <form id="cartsub" action="/sell/cart.php" method="post">
                            <div class="sel_detrtrsjp">
                                <span class="sel_detrtrsb">购买数量：</span><a href="javascript:minusAndPlus(0,660);" class="sel_detrtrsa">－</a>
                                <input name="total" id="buynum" onblur="modifyGoodsNum(this.value,660);" class="sel_detrtrsaon" value="2" />
                                <a href="javascript:minusAndPlus(1,660);" class="sel_detrtrsa">＋</a><span class="sel_detrtrsb">件</span>
                                <p class="clear"></p>
                            </div>
                            <p class="sel_detrtrsjp">总&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价： <b id="tamount" class="colored">1320</b> 元</p>
                            <p>
                                <input type="hidden" id="goodsid" name="itemid" value="85730" />
                                <input type="hidden" name="submits" value="1" />
                        </form>
                        <a href="javascript:void(0);" onclick="checkCart(0);" class="sel_detrtra">
                            <img src="img/sell_icongm.gif" onclick="checkCart(0);" title="加入购物车结算" /></a> <a href="/com/shanxiguofeng/sell/" class="sel_detrtra">
                                <img src="img/sell_iconjr.gif" title="进入商家的店铺" /></a><a href="javascript:void(0);" onclick="scGoods(0,85730,'http://www.nongyao001.com/sell/show-85730.html','http://www.nongyao001.com/file/upload/201411/18/11-52-19-73-23293.jpg.thumb.jpg');" class="sel_detrtra"><img src="img/sell_iconsc.gif" title="收藏此产品" /></a>
                        </p>
                    </div>
                </div>
                <div class="clear"></div>
            ...
            <div class="sel_demid">
                <ul class="sel_demnav">
                    ...
                    <li class="sel_demnavli"><a rel="nofollow" href="javascript:void(0)">交易记录</a><span id="tradelog_nums" style="font-size: 10px; color: red;"></span></li>
                    <li class="sel_demnavli"><a rel="nofollow" href="javascript:void(0)">评价详情</a><span id="tradecomment_nums" style="font-size: 10px; color: red"></span></li>
                ...
                <div class="sel_dembox">
                    <div class="sel_demblm">
						...
						<div class="sel_content">
							产品性能(用途):<br />
							本品为天然植物源农药，具有触杀、胃毒作用。害虫一旦接触药剂，即麻痹神经中枢，继而使虫体蛋白凝固，堵死虫体气孔，使害虫窒息死亡。对正字花科蔬菜上的蚜虫防治效果较好。<br />
							注意事项:<br /> 
							1、本品为植物源类农药，药效缓慢，建议与其他作用机制不同的杀虫剂轮换使用。<br />
							2、本品对鱼类等水生生物有毒，远离水产养殖区施药，药液残渣和清洗药具的水不要污染河塘。禁止在河塘等水域中清洗施药器具。周围开花植物花期、蚕室及桑园附近禁用。<br /> 
							3、本品不能与呈碱性的农药等物质混合使用。 <br />
							4、使用本品时应穿戴防护服和手套，避免吸入药液。施药期间不可抽烟、吃东西和饮水。施药后应及时洗手和洗脸。避免孕妇及哺乳期妇女接触。<br />
							5、安全间隔期：甘蓝上使用为14天，每季最多使用1次。<br /> 
                    ...
                    <div class="sel_demblm">
                        ...
                        <script language="javascript">$(function () { getData_page_tradelog(1, 85730); $("#pagecount_tl span a").live('click', function () { var rel = $(this).attr("rel"); if (rel) { getData_page_tradelog(rel, 85730); } }); });</script>
                    </div>
                    <div class="sel_demblm">
    ...
    <script type="text/javascript">
        ...
        var destoon_member = '';
        destoon_member += '<span class="sp">亲！欢迎来到安徽惠富强农资交易平台！</span><a rel="nofollow" href="http://www.nongyao001.com/member/login.php" class="dl"><img src="img/login.gif"></a><a rel="nofollow" href="#" class="zc"><img src="img/register.gif"></a> <a rel="nofollow" href="#" class="dh">帮助中心</a>';
